...
const CustomCursor = () => {
  ...
  return (
    <>
      ...
      />
      <motion.div
        className="fixed top-0 left-0 w-12 h-12 border-2 border-secondary rounded-full pointer-events-none z-[9998] mix-blend-screen flex items-center justify-center"
        animate={{
